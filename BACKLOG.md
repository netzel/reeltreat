...
## Open
- Slice 1: manifest schema + Playwright login/capture commands
- Slice 2: curation call + cached curation.json
- Slice 3: Remotion compositions (TitleCard, ShotSequence, callouts) + poster renderStill
